...
def run_game
  ...
  if option == 1
    ...
    if card3[0] != "A" && alt_total == nil # no ace, no prior ace
      total += card3.value
      puts "Your cards total #{total}."
      if total > 21
        puts "Bust! Next hand..."
    ...
    elsif card3[0] == "A" && alt_total == nil # ace, but no prior ace
      total += 1
      alt_total = total + 10
    ...
    elsif card3[0] != "A" && alt_total != nil # no ace, but prior ace
      total += card3[0].value
      alt_total += card3[0].value
      puts "Your cards total either #{total} or #{alt_total}."
      if total > 21 && alt_total > 21
        puts "Bust! Next hand..."
        @winnings -= bet
    ...
    if option2 == 1
      card4 = @cards.sample
      puts "Your fourth card is: #{card4[0]} of #{card4[1]}."
      if card4[0] != "A" && alt_total == nil # no ace, no prior ace
        total += card4.value
        puts "Your cards total #{total}."
        if total > 21
          puts "Bust! Next hand..."
      ...
      elsif card4[0] == "A" && alt_total == nil # ace, but no prior ace
        total += 1
        alt_total = total + 11
        puts "Your cards total #{total} or #{alt_total}."
        if total > 21 && alt_total > 21
      ...
      elsif card4[0] != "A" && alt_total != nil && alt_total2 == nil # no ace, but prior ace in round 1 only
        total += card4[0].value
        alt_total += card4[0].value
        puts "Your cards total either #{total} or #{alt_total}."
        if total > 21 && alt_total > 21
          puts "Bust! Next hand..."
          @winnings -= bet
    ...
    elsif card4[0] != "A" && alt_total != nil && alt_total2 != nil # no ace, but prior ace in rounds 1 and 2
      total += card4[0].value
      alt_total += card4[0].value
      alt_total2 += card4[0].value
      alt_total3 += card4[0].value
      puts "Your cards total either #{total}, #{alt_total}, #{alt_total2}, or #{alt_total3}."
      if total > 21 && alt_total > 21
        puts "Bust! Next hand..."
        @winnings -= bet
  ...
  elsif card4[0] == "A" && alt_total != nil && alt_total2 == nil # ace, and prior ace in round 1 or 2 only
    total += 1
    alt_total += 11
    puts "Your cards total either #{total} or #{alt_total}"
    if total > 21 && alt_total > 21
  ...
  elsif card4[0] == "A" && alt_total != nil && alt_total2 != nil # ace, and prior aces in both rounds 1 and 2
    total += 1
    alt_total += 11
    alt_total2 += 1
    alt_total3 += 11
  ...
  puts "Dealer's turn..."
  puts "The dealer's second card is: #{dcard2[0]} of #{dcard2[1]}."
  if dtotal < 17 && dalt_total < 17
    dcard3 = @cards.sample
    puts "Dealer's third card is: #{dcard3[0]} of #{dcard3[1]}."
    if dcard3[0] != "A" && dcard1[0] != "A" && dcard2[0] != "A" # no ace, no prior ace
      dtotal += dcard3.value
    ...
    elsif dcard3[0] == "A" && dcard1[0] != "A" && dcard2[0] != "A" # ace, but no prior ace
      dtotal += 1
    ...
    elsif dcard3[0] != "A" && (dcard1[0] == "A" || dcard2[0] == "A") # no ace, but prior ace
      total += dcard3[0].value
      alt_total += dcard3[0].value
    ...
    elsif dcard3[0] == "A" && (dcard1[0] == "A" || dcard2[0] == "A")
      dtotal += 1
      dalt_total += 11
